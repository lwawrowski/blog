...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outliers <-}\StringTok{ }\NormalTok{cook}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{obs[cook}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{color }\OperatorTok{==}\StringTok{ "outlier"}\NormalTok{]}
...
\includegraphics{Wawrowski_ADR_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\NormalTok{credit <-}\StringTok{ }\KeywordTok{read_xlsx}\NormalTok{(}\StringTok{"data/german_credit_data.xlsx"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{clean_names}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate_if}\NormalTok{(is.character, as.factor) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{job=}\KeywordTok{as.factor}\NormalTok{(job),}
         \DataTypeTok{installment=}\NormalTok{credit_amount}\OperatorTok{/}\NormalTok{duration)}
...
\includegraphics{Wawrowski_ADR_files/figure-latex/unnamed-chunk-62-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{confusionMatrix}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ pred_risk_m1, }\DataTypeTok{reference =}\NormalTok{ credit}\OperatorTok{$}\NormalTok{risk, }\DataTypeTok{positive =} \StringTok{"good"}\NormalTok{, }\DataTypeTok{mode =} \StringTok{"everything"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{split <-}\StringTok{ }\KeywordTok{createDataPartition}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ credit}\OperatorTok{$}\NormalTok{risk, }\DataTypeTok{p =} \FloatTok{0.8}\NormalTok{)}

\NormalTok{train_credit <-}\StringTok{ }\NormalTok{credit[split}\OperatorTok{$}\NormalTok{Resample1,]}
\NormalTok{valid_credit <-}\StringTok{ }\NormalTok{credit[}\OperatorTok{-}\NormalTok{split}\OperatorTok{$}\NormalTok{Resample1,]}

\KeywordTok{summary}\NormalTok{(train_credit)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Wawrowski_ADR_files/figure-latex/unnamed-chunk-66-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred_risk_m2_train <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(}\DataTypeTok{object =}\NormalTok{ m2, }\DataTypeTok{newdata =}\NormalTok{ train_credit, }\DataTypeTok{type =} \StringTok{"class"}\NormalTok{)}
\NormalTok{pred_risk_m2_valid <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(}\DataTypeTok{object =}\NormalTok{ m2, }\DataTypeTok{newdata =}\NormalTok{ valid_credit, }\DataTypeTok{type =} \StringTok{"class"}\NormalTok{)}

\CommentTok{# train}
\KeywordTok{confusionMatrix}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ pred_risk_m2_train, }\DataTypeTok{reference =}\NormalTok{ train_credit}\OperatorTok{$}\NormalTok{risk, }
                \DataTypeTok{positive =} \StringTok{"good"}\NormalTok{, }\DataTypeTok{mode =} \StringTok{"everything"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# valid}
\KeywordTok{confusionMatrix}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ pred_risk_m2_valid, }\DataTypeTok{reference =}\NormalTok{ valid_credit}\OperatorTok{$}\NormalTok{risk, }
                \DataTypeTok{positive =} \StringTok{"good"}\NormalTok{, }\DataTypeTok{mode =} \StringTok{"everything"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
