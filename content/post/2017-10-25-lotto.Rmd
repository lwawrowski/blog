...
Do dnia `r Sys.Date()` przeprowadzono `r nrow(d)` losowań.
...
Okazuje się, że rozkład liczb losowanych w Lotto jest zbliżony do rozkładu jednostajnego. Najrzadziej losowana była liczba 43 - 664 razy, a najczęściej liczba 34 - 802 razy.

Z kolei do przedstawienia rozkładu liczb na poszczególnych pozycjach najlepiej sprawdzi się wykres skrzypcowy.
...
W tym przypadku bez niespodzianek. W ciągu 60 lat 3 losowania wypadły 29 lutego.