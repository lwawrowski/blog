...
Na pierwszym miejscu link do skryptu i do konkretnego rozdziału poświęconemu miarom klasycznym. Kolejne dwa miejsca to przedziały ufności. Kolejne pozycje pokazują, że studenci woleli oglądać screencast aniżeli czytać rozdział skryptu.
